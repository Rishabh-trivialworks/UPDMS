package com.example.updms.rest.services;


import com.example.updms.constants.AppConstants;
import com.example.updms.rest.RequestModel.AddAddressRequest;
import com.example.updms.rest.RequestModel.ChangepasswordRequest;
import com.example.updms.rest.RequestModel.EditProfileUpdateRequest;
import com.example.updms.rest.RequestModel.FamilyRequest;
import com.example.updms.rest.RequestModel.FirebaseRequest;
import com.example.updms.rest.RequestModel.HelpCenterRequestModel;
import com.example.updms.rest.RequestModel.LoginRequest;
import com.example.updms.rest.RequestModel.NodalRequest;
import com.example.updms.rest.RequestModel.PaymentRSARequest;
import com.example.updms.rest.RequestModel.PaymentRequest;
import com.example.updms.rest.RequestModel.RegisterRequest;
import com.example.updms.rest.RequestModel.RenewWorker;
import com.example.updms.rest.RequestModel.SaveBookingModel;
import com.example.updms.rest.RequestModel.UniqueMobileEmailRequest;
...
import com.example.updms.rest.Response.BookNowResponse;
import com.example.updms.rest.Response.CatagoryList;
import com.example.updms.rest.Response.District;
import com.example.updms.rest.Response.Division;
import com.example.updms.rest.Response.LatestUpdate;
import com.example.updms.rest.Response.LoginData;
import com.example.updms.rest.Response.MapItem;
import com.example.updms.rest.Response.MyBooking;
import com.example.updms.rest.Response.NodalList;
import com.example.updms.rest.Response.RSAList;
import com.example.updms.rest.Response.ResponseModel;
import com.example.updms.rest.Response.ServiceproviderList;
import com.example.updms.rest.Response.States;
import com.example.updms.rest.Response.SubCategoryList;
