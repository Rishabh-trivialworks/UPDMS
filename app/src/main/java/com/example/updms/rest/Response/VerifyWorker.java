...
public class VerifyWorker implements Serializable {
    ...
    @Expose
    private String approvedByNodalDate;
    @SerializedName("ApprovedByAdminDate")
    @Expose
    private String approvedByAdminDate;
    ...
    @SerializedName("LabourBOCW")
    @Expose
    private String LabourBOCW;
    @SerializedName("nodalReason")
    @Expose
    private String nodalReason;
    ...
    public String getApprovedByNodalDate() {
        return approvedByNodalDate;
    }

    public void setApprovedByNodalDate(String approvedByNodalDate) {
        this.approvedByNodalDate = approvedByNodalDate;
    }

    public String getApprovedByAdminDate() {
        return approvedByAdminDate;
    }

    public void setApprovedByAdminDate(String approvedByAdminDate) {
    ...
    public String getLabourBOCW() {
        return LabourBOCW;
    }

    public void setLabourBOCW(String labourBOCW) {
        LabourBOCW = labourBOCW;
    }

    public String getNodalReason() {
        return nodalReason;
    }

    public void setNodalReason(String nodalReason) {
        this.nodalReason = nodalReason;
    }
}
